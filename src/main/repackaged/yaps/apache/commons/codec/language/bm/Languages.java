...
package yaps.apache.commons.codec.language.bm;
 ...
 * <blockquote>yaps.apache.commons.codec/language/bm/${{@link NameType#getName()} languages.txt</blockquote>
 * <p>
...
public class Languages {
    ...
    // exposes yaps.apache.commons.codec/language/bm/%s_languages.txt for %s in NameType.* as a list of supported
    ...
    private static String langResourceName(final NameType nameType) {
        return String.format("yaps.apache.commons.codec/language/bm/%s_languages.txt", nameType.getName());
    }
