...
package yaps.apache.http.auth.params;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link yaps.apache.http.client.config.RequestConfig}
 *   and constructor parameters of
 *   {@link yaps.apache.http.auth.AuthSchemeProvider}s.
*/
@Deprecated
public interface AuthPNames {
     ...
     * {@link yaps.apache.http.auth.Credentials}.
     * <p>
     ...
     *  {@link yaps.apache.http.auth.AuthScheme}s when authenticating with
     *  the target host.
     * <p>
     ...
     * {@link yaps.apache.http.auth.AuthScheme#getSchemeName()}.
     */
    public static final String TARGET_AUTH_PREF = "http.auth.target-scheme-pref";

    /**
     * Defines the order of preference for supported
     *  {@link yaps.apache.http.auth.AuthScheme}s when authenticating with the
     *  proxy host.
     * <p>
     * This parameter expects a value of type {@link java.util.Collection}. The
     * collection is expected to contain {@link String} instances representing
