...
import yaps.apache.http.conn.ConnectionReleaseTrigger;
...
public interface AbortableHttpRequest {
    ...
    /**
     * Sets the {@link yaps.apache.http.conn.ClientConnectionRequest}
     ...
     *
     * @see yaps.apache.http.conn.ClientConnectionManager
     */
     ...
     *   {@link yaps.apache.http.conn.ManagedClientConnection} itself.
     * If the request is already aborted, throws an {@link IOException}.
     */
     ...
     *
     * @see yaps.apache.http.client.HttpClient#execute(HttpUriRequest)
     * @see yaps.apache.http.client.HttpClient#execute(yaps.apache.http.HttpHost,
     *      yaps.apache.http.HttpRequest)
     * @see yaps.apache.http.client.HttpClient#execute(HttpUriRequest,
     *      yaps.apache.http.protocol.HttpContext)
     * @see yaps.apache.http.client.HttpClient#execute(yaps.apache.http.HttpHost,
     *      yaps.apache.http.HttpRequest, yaps.apache.http.protocol.HttpContext)
     */
    void abort();
