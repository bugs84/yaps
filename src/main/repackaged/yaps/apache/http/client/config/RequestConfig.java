...
package yaps.apache.http.client.config;
...
public class RequestConfig implements Cloneable {
     ...
     *   yaps.apache.http.impl.conn.PoolingHttpClientConnectionManager#getValidateAfterInactivity()}
     */
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * @deprecated (4.4) Use {@link
         *   yaps.apache.http.impl.conn.PoolingHttpClientConnectionManager#setValidateAfterInactivity(int)}
         */
        @Deprecated
