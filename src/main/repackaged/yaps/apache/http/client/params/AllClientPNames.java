 ...
 *
 */
package yaps.apache.http.client.params;

import yaps.apache.http.auth.params.AuthPNames;
import yaps.apache.http.conn.params.ConnConnectionPNames;
import yaps.apache.http.conn.params.ConnManagerPNames;
import yaps.apache.http.conn.params.ConnRoutePNames;
import yaps.apache.http.cookie.params.CookieSpecPNames;
import yaps.apache.http.params.CoreConnectionPNames;
import yaps.apache.http.params.CoreProtocolPNames;
 ...
 *
 * @deprecated (4.3) use
 *   {@link yaps.apache.http.client.config.RequestConfig},
 *   {@link yaps.apache.http.config.ConnectionConfig},
 *   {@link yaps.apache.http.config.SocketConfig}
 */
@Deprecated
