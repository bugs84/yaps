...
public class VersionInfo {
    ...
    public static VersionInfo loadVersionInfo(final String pckg,
        ...
        try {
            // yaps.apache.http      becomes
            // yaps.apache.http/version.properties
     ...
     * @param pkg
     *            the package for which to load version information, for example "yaps.apache.http". The package name
