 ...
 *
 */
package yaps.apache.http.impl.auth;
...
import yaps.apache.http.Consts;
...
import yaps.apache.http.auth.AuthenticationException;
import yaps.apache.http.auth.ChallengeState;
import yaps.apache.http.auth.Credentials;
import yaps.apache.http.auth.MalformedChallengeException;
import yaps.apache.http.message.BasicHeaderValueFormatter;
import yaps.apache.http.message.BasicNameValuePair;
...
import yaps.apache.http.util.EncodingUtils;
...
public class DigestScheme extends RFC2617Scheme {
    ...
    /**
     * @deprecated (4.2) Use {@link yaps.apache.http.auth.ContextAwareAuthScheme#authenticate(
     *   Credentials, HttpRequest, yaps.apache.http.protocol.HttpContext)}
     */
    @Override
    @Deprecated
     ...
     *
     * @throws yaps.apache.http.auth.InvalidCredentialsException if authentication credentials
