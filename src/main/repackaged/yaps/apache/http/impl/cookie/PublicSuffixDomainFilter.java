...
import yaps.apache.http.conn.util.PublicSuffixList;
...
import yaps.apache.http.cookie.SetCookie;
import yaps.apache.http.util.Args;

/**
 * Wraps a {@link yaps.apache.http.cookie.CookieAttributeHandler} and leverages its match method
 ...
 * available.
 *
 *  @see yaps.apache.http.conn.util.PublicSuffixList
