...
import yaps.apache.http.HttpRequestInterceptor;
import yaps.apache.http.HttpResponseInterceptor;
import yaps.apache.http.annotation.NotThreadSafe;
import yaps.apache.http.auth.AuthSchemeProvider;
import yaps.apache.http.client.AuthenticationStrategy;
import yaps.apache.http.client.BackoffManager;
import yaps.apache.http.client.ConnectionBackoffStrategy;
import yaps.apache.http.client.CookieStore;
import yaps.apache.http.client.CredentialsProvider;
import yaps.apache.http.client.HttpRequestRetryHandler;
import yaps.apache.http.client.RedirectStrategy;
import yaps.apache.http.client.ServiceUnavailableRetryStrategy;
import yaps.apache.http.client.UserTokenHandler;
import yaps.apache.http.client.config.AuthSchemes;
import yaps.apache.http.client.config.CookieSpecs;
import yaps.apache.http.client.config.RequestConfig;
import yaps.apache.http.client.entity.InputStreamFactory;
import yaps.apache.http.client.protocol.RequestAcceptEncoding;
import yaps.apache.http.client.protocol.RequestAddCookies;
import yaps.apache.http.client.protocol.RequestAuthCache;
import yaps.apache.http.client.protocol.RequestClientConnControl;
import yaps.apache.http.client.protocol.RequestDefaultHeaders;
import yaps.apache.http.client.protocol.RequestExpectContinue;
import yaps.apache.http.client.protocol.ResponseContentEncoding;
import yaps.apache.http.client.protocol.ResponseProcessCookies;
import yaps.apache.http.config.ConnectionConfig;
import yaps.apache.http.config.Lookup;
import yaps.apache.http.config.RegistryBuilder;
import yaps.apache.http.config.SocketConfig;
import yaps.apache.http.conn.ConnectionKeepAliveStrategy;
import yaps.apache.http.conn.HttpClientConnectionManager;
import yaps.apache.http.conn.SchemePortResolver;
import yaps.apache.http.conn.routing.HttpRoutePlanner;
import yaps.apache.http.conn.socket.ConnectionSocketFactory;
import yaps.apache.http.conn.socket.LayeredConnectionSocketFactory;
import yaps.apache.http.conn.socket.PlainConnectionSocketFactory;
import yaps.apache.http.conn.ssl.DefaultHostnameVerifier;
import yaps.apache.http.conn.ssl.SSLConnectionSocketFactory;
import yaps.apache.http.conn.ssl.X509HostnameVerifier;
import yaps.apache.http.conn.util.PublicSuffixMatcher;
import yaps.apache.http.conn.util.PublicSuffixMatcherLoader;
import yaps.apache.http.cookie.CookieSpecProvider;
import yaps.apache.http.impl.DefaultConnectionReuseStrategy;
import yaps.apache.http.impl.NoConnectionReuseStrategy;
...
import yaps.apache.http.impl.conn.DefaultProxyRoutePlanner;
import yaps.apache.http.impl.conn.DefaultRoutePlanner;
import yaps.apache.http.impl.conn.DefaultSchemePortResolver;
import yaps.apache.http.impl.conn.PoolingHttpClientConnectionManager;
import yaps.apache.http.impl.conn.SystemDefaultRoutePlanner;
import yaps.apache.http.impl.cookie.DefaultCookieSpecProvider;
import yaps.apache.http.impl.cookie.IgnoreSpecProvider;
import yaps.apache.http.impl.cookie.NetscapeDraftSpecProvider;
import yaps.apache.http.impl.cookie.RFC6265CookieSpecProvider;
import yaps.apache.http.impl.execchain.BackoffStrategyExec;
import yaps.apache.http.impl.execchain.ClientExecChain;
import yaps.apache.http.impl.execchain.MainClientExec;
import yaps.apache.http.impl.execchain.ProtocolExec;
import yaps.apache.http.impl.execchain.RedirectExec;
import yaps.apache.http.impl.execchain.RetryExec;
import yaps.apache.http.impl.execchain.ServiceUnavailableRetryExec;
import yaps.apache.http.protocol.HttpProcessor;
import yaps.apache.http.protocol.HttpProcessorBuilder;
import yaps.apache.http.protocol.HttpRequestExecutor;
import yaps.apache.http.protocol.ImmutableHttpProcessor;
import yaps.apache.http.protocol.RequestContent;
import yaps.apache.http.protocol.RequestTargetHost;
import yaps.apache.http.protocol.RequestUserAgent;
import yaps.apache.http.ssl.SSLContexts;
import yaps.apache.http.util.TextUtils;
import yaps.apache.http.util.VersionInfo;
...
public class HttpClientBuilder {
     ...
     *   yaps.apache.http.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   yaps.apache.http.conn.socket.LayeredConnectionSocketFactory)} methods.
     * </p>
     *
     *   @deprecated (4.4)
     */
     ...
     * with {@link yaps.apache.http.conn.util.PublicSuffixMatcherLoader}.
     *
     * @see yaps.apache.http.conn.util.PublicSuffixMatcher
     * @see yaps.apache.http.conn.util.PublicSuffixMatcherLoader
     *
     *   @since 4.4
     */
     ...
     * <p>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   yaps.apache.http.conn.HttpClientConnectionManager)} method.
     * </p>
     */
     ...
     * yaps.apache.http.protocol.HttpProcessor)} method.
     * </p>
     */
     ...
     *   yaps.apache.http.conn.routing.HttpRoutePlanner)} method.
     */
...
`     */
    ...
    /**
     * Assigns default {@link yaps.apache.http.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link yaps.apache.http.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     */
    ...
    /**
     * Assigns a map of {@link yaps.apache.http.client.entity.InputStreamFactory}s
     ...
     * @see yaps.apache.http.conn.HttpClientConnectionManager#closeExpiredConnections()
     *
     * @since 4.4
     */
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient",
                        "yaps.apache.http.client", getClass());
            }
        }
