...
public interface HttpClientConnectionManager {
     ...
     * by calling {@link #connect(yaps.apache.http.HttpClientConnection,
     *   yaps.apache.http.conn.routing.HttpRoute, int,
     *   yaps.apache.http.protocol.HttpContext) connect} in order to connect
     * directly to the target or to the first proxy hop, optionally calling
     * {@link #upgrade(yaps.apache.http.HttpClientConnection,
     *   yaps.apache.http.conn.routing.HttpRoute,
     *   yaps.apache.http.protocol.HttpContext) upgrade} method to upgrade
     ...
     *  yaps.apache.http.HttpClientConnection,
     *  yaps.apache.http.conn.routing.HttpRoute,
     *  yaps.apache.http.protocol.HttpContext) routeComplete} to mark the route
     *  as fully completed.
     * </p>
     *
