...
package yaps.apache.http.conn.scheme;
 ...
 * @since 4.1
 *
 * @deprecated (4.3) use {@link yaps.apache.http.conn.socket.ConnectionSocketFactory}
 */
@Deprecated
public interface SchemeSocketFactory {
     ...
     * <p>
     * Please note that {@link yaps.apache.http.conn.HttpInetSocketAddress} class should
     * be used in order to pass the target remote address along with the original
     * {@link yaps.apache.http.HttpHost} value used to resolve the address. The use of
     * {@link yaps.apache.http.conn.HttpInetSocketAddress} can also ensure that no reverse
     ...
     *
     * @see yaps.apache.http.conn.HttpInetSocketAddress
     */
