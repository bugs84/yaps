 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link yaps.apache.http.conn.SchemePortResolver} for default port
 * resolution and {@link yaps.apache.http.config.Registry} for socket factory lookups.
 */
@Immutable
@Deprecated
